...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return isMap; });
...
if (typeof Map === 'function') {
  ...
  if (is_map_x_esm_descriptor && typeof is_map_x_esm_descriptor.get === 'function') {
    var is_map_x_esm_res = attempt(function () {
    ...
    if (is_map_x_esm_res.threw === false && isObjectLike(is_map_x_esm_res.value)) {
      is_map_x_esm_res = attempt.call(is_map_x_esm_res.value, is_map_x_esm_descriptor.get);

      if (is_map_x_esm_res.threw === false && isLength(is_map_x_esm_res.value)) {
...
//# sourceMappingURL=is-map-x.js.map
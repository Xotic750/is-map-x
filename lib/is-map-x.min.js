 ...
 * @module is-map-x
 */
"use strict";var attempt,isObjectLike,isLength,getSize,isFalsey=_dereq_("is-falsey-x");if("function"==typeof Map){var descriptor=_dereq_("object-get-own-property-descriptor-x")(Map.prototype,"size");if(descriptor&&"function"==typeof descriptor.get){attempt=_dereq_("attempt-x"),isObjectLike=_dereq_("is-object-like-x");var res=attempt(function(){return new Map});!1===res.threw&&isObjectLike(res.value)&&(isLength=_dereq_("is-length-x"),!1===(res=attempt.call(res.value,descriptor.get)).threw&&isLength(res.value)&&(getSize=descriptor.get))}}module.exports=function isMap(object){if(isFalsey(getSize)||!1===isObjectLike(object))return!1;var result=attempt.call(object,getSize);return!1===result.threw&&isLength(result.value)}},{"attempt-x":3,"is-falsey-x":9,"is-length-x":14,"is-object-like-x":17,"object-get-own-property-descriptor-x":27}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),hop=Object.prototype.hasOwnProperty;module.exports=function hasOwnProperty(object,property){return hop.call(toObject(object),toPropertyKey(property))}},{"to-object-x":36,"to-property-key-x":38}],6:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":15}],11:[function(_dereq_,module,exports){/**
 ...
 * @module is-integer-x
 */
"use strict";var numberIsFinite=_dereq_("is-finite-x"),toInteger=_dereq_("to-integer-x");module.exports=function isInteger(value){return numberIsFinite(value)&&toInteger(value)===value}},{"is-finite-x":10,"to-integer-x":33}],14:[function(_dereq_,module,exports){/**
 ...
 * @module is-length-x
 */
"use strict";var isSafeInteger=_dereq_("is-safe-integer-x");module.exports=function isLength(value){return isSafeInteger(value)&&value>=0}},{"is-safe-integer-x":19}],15:[function(_dereq_,module,exports){/**
 ...
 * @module is-nil-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),isNull=_dereq_("lodash.isnull");module.exports=function isNil(value){return isNull(value)||isUndefined(value)}},{"lodash.isnull":22,"validate.io-undefined":44}],17:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":15,"to-number-x":35}],25:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],26:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":43,"white-space-x":45}],27:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":20}],30:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":16}],31:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":25,"to-integer-x":33}],35:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x");module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?key:toStr(key)}},{"has-symbol-support-x":6,"to-primitive-x":37,"to-string-x":40}],39:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":22,"validate.io-undefined":44}],40:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":21}],41:[function(_dereq_,module,exports){/**
